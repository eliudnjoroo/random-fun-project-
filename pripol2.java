...
public class pripol2 implements ActionListener{

    JFrame aframe=new JFrame();
    JButton back=new JButton("back");
    JLabel l1=new JLabel("  our application does not share any ");
    JLabel l2=new JLabel(" personal or confidential information");
    JLabel l3=new JLabel("    with any 3rd party applications  ");
    JLabel l4=new JLabel(" we highly protect your personal data.");
    JLabel l5=new JLabel("feel calm and be sure about your safety");
